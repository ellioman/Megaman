...
public class Player : MonoBehaviour
{
	...
	protected void Update ()
	{
		if ( IsPlayerInactive == false )
		{
			...
			if( (Input.GetKeyDown(KeyCode.LeftControl) || Input.GetKeyDown(KeyCode.LeftShift)) && m_shooting.CanShoot == true )
			{
				...
				SoundManager.Instance.Play(AirmanLevelSounds.SHOOTING);
			}
	...
	/**/
	protected IEnumerator MakeThePlayerLeaveStage()
	{
		...
		SoundManager.Instance.Play(AirmanLevelSounds.LEAVE_LEVEL);
	...
	/**/
	protected IEnumerator WaitAndReset() {
		/* Before the wait... */
		...
		SoundManager.Instance.Play(AirmanLevelSounds.STAGE);
	...
	public void TakeDamage( float damage )
	{
		...
		{
			SoundManager.Instance.Play(AirmanLevelSounds.HURTING);
